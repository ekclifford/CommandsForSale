...
public abstract class CommandGroup {
    ...
    private boolean containsOnlyOneCommand;
    ...
    public CommandGroup(double permBuyPrice, double oneTimeBuyPrice, String neededPermission,
                        String groupName, boolean canBeOneTimeUsed, boolean onlyContainsOneCommand, ItemStack guiIcon,
        ...
        this.containsOnlyOneCommand = onlyContainsOneCommand;
    }

    public abstract boolean containsCommand(String command);
