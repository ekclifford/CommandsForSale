...
public class Updater {
	 ...
	 * @param type     Specify the type of update this will be. See {@link me.Tecno_Wizard.CommandsForSale.core.Updater.UpdateType}
	...
	public Updater(Plugin plugin, int id, File file, UpdateType type, UpdateCallback callback, boolean announce) {
		...
		try {
			this.url = new URL(Updater.HOST + me.Tecno_Wizard.CommandsForSale.core.Updater.QUERY + this.id);
	 ...
	 * @see me.Tecno_Wizard.CommandsForSale.core.Updater.UpdateResult
	 */
	 ...
	 * @see me.Tecno_Wizard.CommandsForSale.core.Updater.ReleaseType
	 */
	...
	private void downloadFile() {
		...
		try {
			...
			final byte[] data = new byte[me.Tecno_Wizard.CommandsForSale.core.Updater.BYTE_SIZE];
			int count;
			if (this.announce) {
				this.plugin.getLogger().info("About to download a new update: " + this.versionName);
			}
			long downloaded = 0;
			while ((count = in.read(data, 0, me.Tecno_Wizard.CommandsForSale.core.Updater.BYTE_SIZE)) != -1) {
				downloaded += count;
		...
		try {
			...
			while (e.hasMoreElements()) {
				...
				if (!entry.isDirectory()) {
					...
					int b;
					final byte[] buffer = new byte[me.Tecno_Wizard.CommandsForSale.core.Updater.BYTE_SIZE];
					final FileOutputStream fos = new FileOutputStream(destinationFilePath);
					final BufferedOutputStream bos = new BufferedOutputStream(fos, me.Tecno_Wizard.CommandsForSale.core.Updater.BYTE_SIZE);
					while ((b = bis.read(buffer, 0, me.Tecno_Wizard.CommandsForSale.core.Updater.BYTE_SIZE)) != -1) {
	...
	private boolean hasTag(String version) {
		for (final String string : me.Tecno_Wizard.CommandsForSale.core.Updater.NO_UPDATE_TAG) {
	...
	private boolean read() {
		try {
			...
			conn.addRequestProperty("User-Agent", me.Tecno_Wizard.CommandsForSale.core.Updater.USER_AGENT);
			...
			this.versionName = (String) latestUpdate.get(me.Tecno_Wizard.CommandsForSale.core.Updater.TITLE_VALUE);
			this.versionLink = (String) latestUpdate.get(me.Tecno_Wizard.CommandsForSale.core.Updater.LINK_VALUE);
			this.versionType = (String) latestUpdate.get(me.Tecno_Wizard.CommandsForSale.core.Updater.TYPE_VALUE);
			this.versionGameVersion = (String) latestUpdate.get(me.Tecno_Wizard.CommandsForSale.core.Updater.VERSION_VALUE);
	...
	public interface UpdateCallback {
		 ...
		 */
		void onFinish(me.Tecno_Wizard.CommandsForSale.core.Updater updater);
	}
