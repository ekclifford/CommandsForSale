...
public class Resources {
    ...
    private String versionInformation =
            ChatColor.AQUA + "[CommandsForSale] Welcome to CommandsForSale Version 1.2.3!\n" +
                    "Added one time use commands to the GUI. " +
                    ChatColor.RED + "WARNING! Plugin will no longer download itself due to multitudes of issues that users have been having with it. The auto-download field will now be ignored.\n" +
                    "WARNING! This is the last edition of CommandsForSale major version 1." +
                    ChatColor.GREEN + "The next edition will be 2.0 with major code updates, regular expression matching," +
                    " Multi-language, and much more! Note that this will not be released for a while. The plugin is being completely rewritten.";
    Resources(Main main) {
