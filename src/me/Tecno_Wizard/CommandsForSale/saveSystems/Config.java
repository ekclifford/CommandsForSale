...
public class Config
{
    ...
    public List<Byte> getByteList(String path) {return this.config.getByteList(path);}
    ...
    public void reloadConfig() {this.config = YamlConfiguration.loadConfiguration(new InputStreamReader(manager.getConfigContent(file)));}
