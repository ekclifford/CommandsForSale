package me.Tecno_Wizard.CommandsForSale.saveSystems;
 ...
 * 
 * Primary edits by Kyler, A YouTuber by the name of AppljuzeProgramming
 * https://www.youtube.com/user/AppljuzeProgramming/featured
 * 
 * Slight secondary edits by Ethan, known as Tecno_Wizard to the Minecraft world, to adjust for depreciated/missing methods, chiche class names, and to add javadoc definitions
 * to methods that he could figure out was the function was.
 * 
 */
...
public class ConfigManager
{
	 ...
	 * @param plugin The main class of your plugin (extends JavaPlugin)
	 */
	...
	/**
	 * Gets the specified YML file from the plguin's resource folder.
	 * If the file already exists, the existing file will be returned.
	 * If the file does not already exist, a YAML file with the same name will be created and returned.
	 * @param fileName Name of the YAML to return. Note that the file name must end in .yml
	 * @param header Strings used as the header of the file.
	 * @return The requested YAML file
	 */
	 ...
	 * Gets the specified YML file from the plguin's resource folder.
	 * If the file already exists, the existing file will be returned.
	 * If the file does not already exist, a YamlConfiguration file with the same name will be created and returned.
	 * @param fileName Name of the YAML to return. Note that the file name must end in .yml
	 * @return The requested YAML file
	 */
	...
	/**
	 * Loads the specified file. If the file does not exist at the specified path, it will be created.
	 * @param filePath Path of the file to prepare.
	 * @param resource The name of the file to prepare
	 */
	 ...
	 * @param resource Resource to copy to the file
	 * @param file The file that will be written to by the resource
	 */
